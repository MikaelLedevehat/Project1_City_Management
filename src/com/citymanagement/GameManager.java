...
public final class GameManager{
	...
	public GameManager() {
		w = new World();
		w.addPopulation(PopulationFactory.createHumanPopulation(20, new Vector2(200, 200)));
		w.addPopulation(PopulationFactory.createRessourcePopulation(20, new Vector2(200, 200)));
	}
}
