...
public final class GameManager{
	...
	public GameManager() {
		w = new World();
		w.addPopulation(PopulationFactory.createHumanPopulation(2, new Vector2(200, 200)));
		w.addPopulation(PopulationFactory.createRessourcePopulation(0, new Vector2(200, 200)));
	}
}
